...
def main(config):
    ...
    if response_status_code == 200:
        ...
        if airly_street_out_cache == None or airly_id != airly_id_out_cache:
            ...
            response_installations = http.get(url=AIRLY_INSTALLATIONS_URL % airly_id, headers=headers)

            print(cache.get("airly_api_limit_counter_in_cache"))
    ...
    if response_status_code == 200:
        ...
        if airly_pm25_out_cache != None and airly_pm10_out_cache != None and airly_id == cache.get("airly_id"):
            ...
            print("Getting cached data measurments")
            ...
            headers = {"Accept": "application/json", "apikey": airly_apikey,}
            response_measurements = http.get(url=AIRLY_MEASUREMENTS_URL  % airly_id, headers=headers)
